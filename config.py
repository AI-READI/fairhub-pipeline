...
# Dev - Dangerous
AZURE_STORAGE_PRODUCTION_DANGEROUS_CONNECTION_STRING = get_env(
    "AZURE_STORAGE_PRODUCTION_DANGEROUS_CONNECTION_STRING"
)
...
FAIRHUB_ENV_SENSOR_LOG_ENDPOINT = get_env(
    "FAIRHUB_ENV_SENSOR_LOG_ENDPOINT", optional=True
)
FAIRHUB_OPTOMED_LOG_ENDPOINT = get_env("FAIRHUB_OPTOMED_LOG_ENDPOINT", optional=True)
...
FAIRHUB_CIRRUS_LOG_ENDPOINT = get_env("FAIRHUB_CIRRUS_LOG_ENDPOINT", optional=True)

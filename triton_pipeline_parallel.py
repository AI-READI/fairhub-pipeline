...
def pipeline(study_id: str, workers: int = 4, args: list = None):
    ...
    processed_data_output_folder = f"{study_id}/pooled-data/Triton-processed-parallel"
    processed_metadata_output_folder = f"{study_id}/pooled-data/Triton-metadata-parallel"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Process triton data files")
    parser.add_argument(

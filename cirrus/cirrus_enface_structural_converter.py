...
def write_dicom(protocol, dicom_dict_list, opt, op, opt_file, enface_file, file_path):
    """
    ...
    for key in keys:
        ...
        referenced_series_sequence_structural(dataset, dicom_dict_list, opt, op)
...
def convert_dicom(
    inputenface, inputopt, inputop, output

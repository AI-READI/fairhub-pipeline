...
def pipeline(thread_count=4):  # sourcery skip: low-code-quality
    ...
    source_folders = [
        "Mini-Dataset/cardiac_ecg/ecg_12lead/philips_tc30",
        "Mini-Dataset/environment/environmental_sensor/leelab_anura",
        "Mini-Dataset/retinal_flio/flio/heidelberg_flio",
        "Mini-Dataset/retinal_oct/structural_oct/heidelberg_spectralis",
        "Mini-Dataset/retinal_oct/structural_oct/topcon_maestro2",
        "Mini-Dataset/retinal_oct/structural_oct/topcon_triton",
        "Mini-Dataset/retinal_oct/structural_oct/zeiss_cirrus",
        "Mini-Dataset/retinal_octa/enface/heidelberg_spectralis",
        "Mini-Dataset/retinal_octa/enface/topcon_maestro2",
        "Mini-Dataset/retinal_octa/enface/topcon_triton",
        "Mini-Dataset/retinal_octa/enface/zeiss_cirrus",
        "Mini-Dataset/retinal_octa/flow_cube/heidelberg_spectralis",
        "Mini-Dataset/retinal_octa/flow_cube/topcon_maestro2",
        "Mini-Dataset/retinal_octa/flow_cube/topcon_triton",
        "Mini-Dataset/retinal_octa/flow_cube/zeiss_cirrus",
        "Mini-Dataset/retinal_octa/segmentation/heidelberg_spectralis",
        "Mini-Dataset/retinal_octa/segmentation/topcon_maestro2",
        "Mini-Dataset/retinal_octa/segmentation/topcon_triton",
        "Mini-Dataset/retinal_octa/segmentation/zeiss_cirrus",
        "Mini-Dataset/retinal_photography/cfp/icare_eidon",
        "Mini-Dataset/retinal_photography/cfp/optomed_aurora",
        "Mini-Dataset/retinal_photography/cfp/topcon_maestro2",
        "Mini-Dataset/retinal_photography/cfp/topcon_triton",
        "Mini-Dataset/retinal_photography/faf/icare_eidon",
        "Mini-Dataset/retinal_photography/ir/heidelberg_spectralis",
        "Mini-Dataset/retinal_photography/ir/icare_eidon",
        "Mini-Dataset/retinal_photography/ir/topcon_maestro2",
        "Mini-Dataset/retinal_photography/ir/zeiss_cirrus",
        "Mini-Dataset/wearable_activity_monitor/heart_rate/garmin_vivosmart5",
        "Mini-Dataset/wearable_activity_monitor/oxygen_saturation/garmin_vivosmart5",
        "Mini-Dataset/wearable_activity_monitor/physical_activity/garmin_vivosmart5",
        "Mini-Dataset/wearable_activity_monitor/physical_activity_calorie/garmin_vivosmart5",
        "Mini-Dataset/wearable_activity_monitor/respiratory_rate/garmin_vivosmart5",
        "Mini-Dataset/wearable_activity_monitor/sleep/garmin_vivosmart5",
        "Mini-Dataset/wearable_activity_monitor/stress/garmin_vivosmart5",
        "Mini-Dataset/wearable_blood_glucose/continuous_glucose_monitoring/dexcom_g6",
    ]

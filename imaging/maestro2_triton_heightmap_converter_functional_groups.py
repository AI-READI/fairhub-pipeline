...
def per_frame_functional_groups_sequence(dataset, x, y):
    """
    ...
    for i in range(repeat):
        ...
        frame_content_item.StackID = (
            y[0]["52009230"].value[i]["00209111"].value[0]["00209056"].value
        )
        frame_content_item.InStackPositionNumber = (
            y[0]["52009230"].value[i]["00209111"].value[0]["00209057"].value
        )
        frame_content_item.DimensionIndexValues = (
            y[0]["52009230"].value[i]["00209111"].value[0]["00209157"].value
        )
        ...
        segment_identification_item.ReferencedSegmentNumber = num
        num = num + 1
...
def segment_sequence(dataset, x, y):
    ...
    for i in range(repeat):
        ...
        segmentation_algorithm_identification_seq = pydicom.Sequence()
        segmentation_algorithm_identification_item = pydicom.Dataset()

        segmentation_algorithm_identification_item.AlgorithmSource = "Topcon"
        segmentation_algorithm_identification_item.AlgorithmVersion = (
            x[0]["00620002"]
            .value[i]["0066002B"]
            .value[0]["0066002D"]
            .value[0]["00660031"]
        ...
        segmentation_algorithm_identification_item.AlgorithmName = (
            x[0]["00620002"]
            .value[i]["0066002B"]
            .value[0]["0066002D"]
            .value[0]["00660036"]
        ...
        segmentation_algorithm_identification_item.AlgorithmFamilyCodeSequence = (
            algorithm_family_code_seq
        )
        segmentation_algorithm_identification_seq.append(
            segmentation_algorithm_identification_item
        )
        ...
        segmented_property_type_code_item.CodeValue = (
            x[0]["00620002"].value[i]["0062000F"].value[0]["00080100"].value
        )
        segmented_property_type_code_item.CodingSchemeDesignator = (
            x[0]["00620002"].value[i]["0062000F"].value[0]["00080102"].value
        )
        segmented_property_type_code_item.CodeMeaning = (
            x[0]["00620002"].value[i]["0062000F"].value[0]["00080104"].value
        )
        ...
        segment_item.SegmentationAlgorithmIdentificationSequence = (
            segmentation_algorithm_identification_seq
        )
        ...
        segment_item.SegmentNumber = x[0]["00620002"].value[i]["00620004"].value
        segment_item.SegmentLabel = x[0]["00620002"].value[i]["00620005"].value
        segment_item.SegmentDescription = x[0]["00620002"].value[i]["00620006"].value
        segment_item.SegmentAlgorithmType = x[0]["00620002"].value[i]["00620008"].value
        segment_item.SegmentAlgorithmName = (
            x[0]["00620002"]
            .value[i]["0066002B"]
            .value[0]["0066002D"]
            .value[0]["00660036"]
        ...
        segment_item.RecommendedDisplayCIELabValue = (
            x[0]["00660002"].value[i]["0062000D"].value
        )
        segment_item.RecommendedDisplayGrayscaleValue = (
            x[0]["00660002"].value[i]["0062000C"].value
        )

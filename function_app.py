...
from cgm_pipeline import pipeline as stage_one_cgm_pipeline
...
@app.route(route="process-cgm", auth_level=func.AuthLevel.FUNCTION)
def process_cgm(req: func.HttpRequest) -> func.HttpResponse:
    # Block all other methods
    if req.method != "POST":
        return func.HttpResponse(
            "Method not allowed", status_code=405, mimetype="text/plain"

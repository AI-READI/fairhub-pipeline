...
def merge_json_files(file_paths , outdir , ptname):
    ...
    combined_data = {
        ...
        'body': {
            'heart_rate': combined_body_heart_rate
        }
    }
        ...
        try:
            ...
            for entry in os.listdir(monitor_files):
                ...
                if os.path.isdir(full_path):
                    hr_file = root_dir + pt  + "/Garmin/Monitor/" + entry + "/heart_rate_data_*.csv"
            ...
            out_directory = 'heart_rate/garmin_vivosmart5/' + pt.replace("FitnessTracker-" , "")
            out_directory_path = Path('heart_rate/garmin_vivosmart5/' + pt.replace("FitnessTracker-" , ""))
